            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}" autocomplete="off">
                        ...
                        <h6 class="heading-small text-muted mb-4">Informasi saya</h6>
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="phone_number">Nomor Telepon<span class="small text-danger">*</span></label>
                                        <input type="text" id="phone_number" class="form-control" name="phone_number" placeholder="Nomor Telepon" value="{{ old('phone_number', Auth::user()->phone_number) }}">
                                    </div>
                                </div>
                            </div>
